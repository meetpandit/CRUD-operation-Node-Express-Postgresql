const Customer = require('../config/db.config').Customer
...
module.exports ={ save, create , retrieveAllCustomers , getCustomerById , updateById , deleteById , filteringByAge, pagination ,pagingfilteringsorting }
